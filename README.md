...
## 2. Information as a Carrier of State (EN)
...
### 2. Informacja jako nośnik stanu (PL)
...
## 4. Interference and Resonance (EN)
...
## 5. Emergent Physical Properties (EN)
...
### 5. Emergentne właściwości fizyczne (PL)
...
- `/models` — mathematical and conceptual models  
- `/examples` — practical applications  
- `/notes` — drafts and internal development  

### Struktura repozytorium (PL)
Repozytorium będzie zawierać:
- `/docs` — pełna dokumentacja, diagramy, słownik  
- `/models` — modele matematyczne i koncepcyjne  
